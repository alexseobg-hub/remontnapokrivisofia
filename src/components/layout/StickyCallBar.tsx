...
export function StickyCallBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-2 border-t border-graphite-800 bg-graphite-900 lg:hidden">
      <a
        href={telHref()}
        onClick={() => trackPhoneClick('sticky-bar')}
        className="flex items-center justify-center gap-2 px-3 py-4 font-display text-[0.9375rem] font-bold text-white"
      >
